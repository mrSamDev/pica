...
const threadPoolTypes = new Set(["FSREQCALLBACK", "FSREQPROMISE", "GETADDRINFOREQWRAP", "GETNAMEINFOREQWRAP", "PBKDF2REQUEST", "RANDOMBYTESREQUEST", "SCRYPTREQUEST", "SIGNREQUEST", "VERIFYREQUEST", "ZLIB"]);
...
await pipeline(fs.createReadStream("huge-file.txt"), processStream, fs.createWriteStream("output.txt"));
```
