...
type SearchParams<TConfig extends BaseRouterConfig, TRoute extends keyof TConfig> = TConfig[TRoute]["search"] extends string[] ? TupleToSearchParams<TConfig[TRoute]["search"]> : undefined;
```
